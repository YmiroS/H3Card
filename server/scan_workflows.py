...
NOTES = {
    "zimage_i2i": "先让模型「看懂」你这张图、写成一段话，再照着那段话重画一张 —— "
                  ...
                  "反而会让它照着描述跑偏。基础参数默认跟随原图比例，也可选择输出比例和短边清晰度；指定比例会中心裁切主图。"
...
def h3_character_transfer_inputs(api):
    ...
    return [
        ...
        {"key": "preview_seconds", "label": "仅测试前几秒", "type": "slider",
         "min": 0, "max": 15, "step": 5, "default": 0,
         "hint": "0 = 生成完整视频；5/10/15 = 只生成来源视频开头对应时长，用于快速确认人物迁移效果。",
         "target": {"node": "11", "input": "timeline_data", "kind": "timeline_option"}},
